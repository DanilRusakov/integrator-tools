const GEO_LANG_MAP = {
    ...
    IT: 'IT', SM: 'IT', VA: 'IT',
    ES: 'ES', MX: 'ES', CO: 'ES', CL: 'ES', EC: 'ES', PE: 'ES', UY: 'ES', PY: 'ES', HN: 'ES', SV: 'ES', GT: 'ES', CR: 'ES', PA: 'ES', DO: 'ES', VE: 'ES', BO: 'ES', PR: 'ES', GQ: 'ES',
    PT: 'PT', BR: 'PT', AO: 'PT', MZ: 'PT', GW: 'PT', ST: 'PT', TL: 'PT', CV: 'PT',
    NL: 'NL', BQ: 'NL', CW: 'NL', SX: 'NL', AW: 'NL', SR: 'NL',
    EN: 'EN', US: 'EN', GB: 'EN', IE: 'EN', ZA: 'EN', IN: 'EN', PH: 'EN', SG: 'EN', CA: 'EN', AG: 'EN', BS: 'EN', BB: 'EN', BZ: 'EN', DM: 'EN', GD: 'EN', JM: 'EN', KN: 'EN', LC: 'EN', VC: 'EN', TT: 'EN', GY: 'EN',
    RU: 'RU', UA: 'RU', BY: 'RU', KZ: 'RU', MD: 'RU',
